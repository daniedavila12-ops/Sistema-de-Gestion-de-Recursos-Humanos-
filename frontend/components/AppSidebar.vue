<template>
  <div>
    ...
    <aside 
      ...
      class="w-64 bg-slate-800 text-white flex flex-col shadow-xl fixed left-0 top-0 h-full z-50 transition-transform duration-300"
    >
      <div class="p-6 text-2xl font-bold border-b border-slate-700 tracking-tight text-blue-400 uppercase flex justify-between items-center">
        <span>RRHH Innova</span>
