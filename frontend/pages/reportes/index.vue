  ...
  <div class="min-h-screen bg-gray-100 flex font-sans overflow-x-hidden">
    ...
    <main class="flex-1 md:ml-64 p-4 md:p-6 w-full transition-all printable-area">
      ...
      <div class="flex border-b border-slate-200 mb-6 overflow-x-auto no-print">
        ...
        <button @click="activeTab = 'empleados'" :class="['px-6 py-3 font-bold text-xs uppercase tracking-widest whitespace-nowrap border-b-2 transition-colors flex items-center gap-2', activeTab === 'empleados' ? 'border-blue-500 text-blue-600' : 'border-transparent text-slate-500 hover:text-slate-700 hover:border-slate-300']">
          👥 Plantilla & Empleados
          <span v-if="empleados.length" class="text-[9px] font-black bg-blue-100 text-blue-600 px-1.5 py-0.5 rounded-full">{{ empleados.length }}</span>
        </button>
        <button @click="activeTab = 'incidencias'" :class="['px-6 py-3 font-bold text-xs uppercase tracking-widest whitespace-nowrap border-b-2 transition-colors flex items-center gap-2', activeTab === 'incidencias' ? 'border-rose-500 text-rose-600' : 'border-transparent text-slate-500 hover:text-slate-700 hover:border-slate-300']">
          🚨 Incidencias Laborales
          <span v-if="incidenciasDatos.length" class="text-[9px] font-black bg-rose-100 text-rose-600 px-1.5 py-0.5 rounded-full">{{ incidenciasDatos.length }}</span>
        </button>
        ...
        <button @click="activeTab = 'legales'" :class="['px-6 py-3 font-bold text-xs uppercase tracking-widest whitespace-nowrap border-b-2 transition-colors flex items-center gap-2', activeTab === 'legales' ? 'border-indigo-500 text-indigo-600' : 'border-transparent text-slate-500 hover:text-slate-700 hover:border-slate-300']">
          ⚖️ Docs & Legales
          <span v-if="legalesDatos.length" class="text-[9px] font-black bg-indigo-100 text-indigo-600 px-1.5 py-0.5 rounded-full">{{ legalesDatos.length }}</span>
        </button>
        <button @click="activeTab = 'tickets'" :class="['px-6 py-3 font-bold text-xs uppercase tracking-widest whitespace-nowrap border-b-2 transition-colors flex items-center gap-2', activeTab === 'tickets' ? 'border-amber-500 text-amber-600' : 'border-transparent text-slate-500 hover:text-slate-700 hover:border-slate-300']">
          🎫 Soporte & Tickets
      ...
      <div v-if="activeTab === 'dashboard'" class="space-y-6 animate-in fade-in duration-300">
        ...
        <div class="flex justify-between items-center bg-white p-4 rounded-2xl shadow-sm border border-slate-200">
           <div>
             <h2 class="text-lg font-black text-slate-800 uppercase tracking-tight">Resumen Ejecutivo</h2>
      ...
      <div v-if="activeTab === 'empleados'" class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
        <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4 border-b border-slate-100 pb-4">
          <h2 class="text-lg font-black text-slate-800 uppercase tracking-tight">Directorio Analítico</h2>
      ...
      <div v-if="activeTab === 'incidencias'" class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 animate-in fade-in duration-300">
        <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4 border-b border-slate-100 pb-4">
          <h2 class="text-lg font-black text-slate-800 uppercase tracking-tight text-rose-600">🚨 Incidencias Laborales</h2>
      ...
      <div v-if="activeTab === 'legales'" class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 animate-in fade-in duration-300">
        <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4 border-b border-slate-100 pb-4">
          <h2 class="text-lg font-black text-slate-800 uppercase tracking-tight text-indigo-600">⚖️ Documentación Legal y Vencimientos</h2>
          <div class="flex flex-col md:flex-row gap-3 w-full md:w-auto items-center">
      ...
      <div v-if="activeTab === 'tickets'" class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
        <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4 border-b border-slate-100 pb-4">
          <h2 class="text-lg font-black text-slate-800 uppercase tracking-tight">Análisis de Soporte</h2>
          <div class="flex flex-col md:flex-row gap-3 w-full md:w-auto items-center">
      ...
      <div v-if="activeTab === 'tiempos'" class="space-y-6 animate-in fade-in duration-300">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center bg-white p-6 rounded-2xl shadow-sm border border-slate-200 gap-4">
           <div>
             <h2 class="text-xl font-black text-slate-800 uppercase tracking-tight text-emerald-600">⏳ Reporte de Control de Tiempos</h2>
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4 border-b border-slate-100 pb-4">
          <h2 class="text-lg font-black text-slate-800 uppercase tracking-tight">Proyecciones de Vacaciones</h2>
          <div class="flex flex-col md:flex-row gap-3 w-full md:w-auto">
