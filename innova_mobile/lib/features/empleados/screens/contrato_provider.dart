...
class ContratoRepository {
  ...
  Future<void> updateContrato(int empleadoId, int contratoId, Map<String, String?> contratoData, PlatformFile? archivo) async {
    final request = http.MultipartRequest('PUT', Uri.parse('$_apiUrl/empleados/$empleadoId/contratos/$contratoId'));
    ...
    if (response.statusCode != 200) {
      final responseBody = await response.stream.bytesToString();
      throw Exception('Error al actualizar el contrato: $responseBody');
    }
  }
}